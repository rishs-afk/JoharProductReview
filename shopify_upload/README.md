...
Use `shopify_products_matched_only_GITHUB_IMAGE_URLS_PRODUCT_FIRST.csv` for Shopify re-imports. It keeps the same 367 matched products, but moves clean SKU product photos ahead of `WEB_ALT` lifestyle/model photos wherever a product image is available.
